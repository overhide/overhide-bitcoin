...
const NETWORK_TYPE = process.env.NETWORK_TYPE || process.env.npm_config_NETWORK_TYPE || process.env.npm_package_config_NETWORK_TYPE || 'test3';
...
const eth = require('../../main/js/lib/btc-chain.js').init({btc_network: NETWORK_TYPE});
